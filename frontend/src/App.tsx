...
//   // 🔔 ESTADOS DO COMPONENTE DE ALERTA/NOTIFICAÇÃO (Mantidos caso queira reativar no futuro)
//   const [menuNotificacaoAberto, setMenuNotificacaoAberto] = useState(false)
//   const [notificacoes, setNotificacoes] = useState<any[]>([])

//   const naoLidas = notificacoes.filter(n => !n.lida).length

//   // Função que simula a busca automática de notificações no banco/API
...
//     } catch (err) {
//       console.error("Não foi possível atualizar as notificações:", err);
//     }
//   }

//   // ⏱️ POLING DESATIVADO TEMPORARIAMENTE (Evita requisições em segundo plano enquanto o alerta não é usado)
//   useEffect(() => {
//     if (user) {
//       // loadNotificacoes(); // Desativado para limpeza de tela
...
//               {/* 🔔 SISTEMA DE ALERTA OCULTADO (false && bloqueia a renderização de forma limpa) */}
//               {false && (
...
//                 ) : (
//                   <tr>
//                     <td colSpan={3} style={{ textAlignment: 'center', padding: '40px', color: '#94a3b8' }}>
        ...
        <div className="workspace-grid">
          ...
          {selectedPortaria && (
            <div className="detail-panel">
              ...
              {/* 🔄 SEÇÃO DO GRÁFICO TOTALMENTE ADAPTATIVA */}
              <div className="graph-section">
                <h4 style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginBottom: '15px', textTransform: 'uppercase', fontSize: '11px', color: '#94a3b8', letterSpacing: '1px', fontWeight: 700 }}>
                  <Network size={16} /> Mapa Visual de Relações
                </h4>
