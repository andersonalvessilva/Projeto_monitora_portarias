...
//   const [isLoading, setIsLoading] = useState(false); // 🎯 Controla o feedback visual de clique
...
//     try {
//       // Simula uma pequena espera de rede (800ms) para deixar a transição profissional
//       await new Promise((resolve) => setTimeout(resolve, 800));

//       // 2. Validação simulada de credenciais administrativas para a Fase 1
//       if (username.toLowerCase().trim() === "admin" && password === "sesa@2026") {
//         // Autentica passando o nome tratado para o cabeçalho do painel
...
//       {/* SEU FUNDO ORIGINAL: Linhas de dados, malha e nós de monitoramento */}
//       <div 
//         style={{
//           position: "absolute",
//           inset: 0,
...
//               {isLoading ? "Autenticando acesso..." : "Entrar no Sistema"}
//             </button>
//           </form>
