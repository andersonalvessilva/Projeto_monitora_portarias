...
//     } else {
//       // Mensagem de erro caso a senha ou o usuário estejam incorretos
...
//     // 2. Validação simulada de credenciais (Usuário e Senha de teste)
//     // O username.toLowerCase() garante que funcionará mesmo se digitar "Admin" ou "ADMIN"
//     if (username.toLowerCase().trim() === "admin" && password === "sesa@2026") {
//       setError("");
//       // Autentica passando o nome digitado para compor o cabeçalho
//       onLoginSuccess(username);
